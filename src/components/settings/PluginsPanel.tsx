  ...
  return (
    <section className="border p-4 space-y-4 border-border bg-surface">
      <div className="space-y-2">
        <div className="text-xs uppercase tracking-[0.24em] text-muted">plugin controls</div>
      ...
      <Link
        href="/plugins"
        className="flex items-center justify-between gap-4 border p-3 text-sm border-accent text-accent bg-accent-glow"
      >
